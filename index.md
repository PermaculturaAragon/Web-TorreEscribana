...
<div class="hero-home">
  <div class="hero-home__overlay">
    <p class="hero-home__pill ">
      Centro demostrativo de Permacultura
    </p>

    <h1 class="hero-home__title">
      Vivir mejor cuidando la tierra
    </h1>

    <p class="hero-home__subtitle">
      Un oasis de huerta cerca de Zaragoza, regado por las aguas del río Gállego.
    </p>

    <div class="hero-home__buttons">
      <a href="{{ '/visitas' | absolute_url }}" class="btn-te btn-te--slim">
        Visita Torre Escribana
      </a>
      <a href="{{ '/proyecto' | absolute_url }}" class="btn-te btn-te--outline btn-te--slim">
...
<section class="bloque-inspiracion">
  ...
  <blockquote class="cita-inspiracion">
    «Cuidar la tierra es cuidarnos a nosotras mismas.»<br>
    <span class="autor">Bill Mollison</span>
  </blockquote>
